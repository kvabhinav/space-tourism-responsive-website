...
export default function Planets(props){
    return(
        <div className="w-screen h-max md:h-screen grid lg:grid-flow-dense lg:grid-cols-2 px-5 lg:px-0 pt-24 lg:pt-40 lg:pl-32">
            <div className="flex flex-col justify-center items-center gap-y-6 md:gap-y-4 lg:gap-y-20">
                <h2 className="text-white md:self-start text-base lg:text-[28px] font-barlow tracking-[2.7px] lg:tracking-[4.72px] md:pl-10"><span className="text-white/20 font-bold">01 </span>PICK YOUR DESTINATION</h2>
                <img src={props.data.image} alt="" className="w-[170px] md:w-[300px] lg:w-[444px]" />
            </div>
            <div className="flex flex-col justify-evenly items-center lg:items-start pt-10 md:pt-0 lg:pt-28 lg:pb-20">
                <div>
